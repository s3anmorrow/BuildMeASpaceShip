var BlastOffStage = function() {
    ...
    var ground = assetManager.getSprite("interface","ground",0,0,false);
    ground.y = 853;
    screen.addChild(ground);

    var countDownIndex = 5;
    var countDown = [];
    countDown[5] = assetManager.getSprite("interface","countdown5", 271, -160, false);
    countDown[4] = assetManager.getSprite("interface","countdown4", 271, -160, false);
    countDown[3] = assetManager.getSprite("interface","countdown3", 271, -160, false);
    countDown[2] = assetManager.getSprite("interface","countdown2", 271, -160, false);
    countDown[1] = assetManager.getSprite("interface","countdown1", 271, -160, false);
    countDown[0] = assetManager.getSprite("interface","countdownBlastOff", 150, -240, false);

    // the spaceship sprite
    var spaceShipContainer = spaceShip.getShipContainer();

    var btnGo = assetManager.getSprite("interface","btnGoUp", 255, 100, false);
